...
function useOnScreen(ref: RefObject<HTMLParagraphElement|null>, rootMargin = '0px') {
...
export default function Mission() {
  const AnimatedParagraph: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
      <p
        ref={ref}
        className={`leading-relaxed transition-opacity duration-700 ease-out transform ${
