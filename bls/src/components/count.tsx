...
export default function StatsRow() {
  const stats: Stat[] = [
    { icon: '/count/1.svg', number: 19609, label: 'People trained' },
    { icon: '/count/2.svg', number: 22023, label: 'Pledges Taken' },
    { icon: '/count/3.svg', number: 295, label: 'Sessions Organized' },
  ]
