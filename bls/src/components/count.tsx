...
export default function StatsRow() {
  const stats: Stat[] = [
    { icon: '/count/1.svg', number: 16692, label: 'People trained' },
    { icon: '/count/2.svg', number: 19076, label: 'Pledges Taken' },
    { icon: '/count/3.svg', number: 235, label: 'Sessions Organized' },
  ]
