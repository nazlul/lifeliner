...
export default function StatsRow() {
  const stats: Stat[] = [
    { icon: '/count/1.svg', number: 20775, label: 'People trained' },
    { icon: '/count/2.svg', number: 24059, label: 'Pledges Taken' },
    { icon: '/count/3.svg', number: 315, label: 'Sessions Organized' },
  ]
