...
export default function StatsRow() {
  const stats: Stat[] = [
    { icon: '/count/1.svg', number: 12062, label: 'People trained' },
    { icon: '/count/2.svg', number: 12963, label: 'Pledges Taken' },
    { icon: '/count/3.svg', number: 168, label: 'Sessions Organized' },
  ]
