...
export default function StatsRow() {
  const stats: Stat[] = [
    { icon: '/count/1.svg', number: 20561, label: 'People trained' },
    { icon: '/count/2.svg', number: 23845, label: 'Pledges Taken' },
    { icon: '/count/3.svg', number: 312, label: 'Sessions Organized' },
  ]
