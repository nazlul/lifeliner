...
export default function StatsRow() {
  const stats: Stat[] = [
    { icon: '/count/1.svg', number: 20226, label: 'People trained' },
    { icon: '/count/2.svg', number: 23510, label: 'Pledges Taken' },
    { icon: '/count/3.svg', number: 305, label: 'Sessions Organized' },
  ]
