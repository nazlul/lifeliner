...
export default function StatsRow() {
  const stats: Stat[] = [
    { icon: '/count/1.svg', number: 11858, label: 'People trained' },
    { icon: '/count/2.svg', number: 12363, label: 'Pledges Taken' },
    { icon: '/count/3.svg', number: 164, label: 'Sessions Organized' },
  ]
