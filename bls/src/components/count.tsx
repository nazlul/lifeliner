...
export default function StatsRow() {
  const stats: Stat[] = [
    { icon: '/count/1.svg', number: 17314, label: 'People trained' },
    { icon: '/count/2.svg', number: 19728, label: 'Pledges Taken' },
    { icon: '/count/3.svg', number: 247, label: 'Sessions Organized' },
  ]
