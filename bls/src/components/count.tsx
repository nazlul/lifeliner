...
export default function StatsRow() {
  const stats: Stat[] = [
    { icon: '/count/1.svg', number: 16901, label: 'People trained' },
    { icon: '/count/2.svg', number: 19285, label: 'Pledges Taken' },
    { icon: '/count/3.svg', number: 238, label: 'Sessions Organized' },
  ]
