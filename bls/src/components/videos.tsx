...
export default function Videos() {
  ...
  return (
    <section className="relative py-16 px-4 md:px-25 bg-gradient-to-b from-[#edf1f7] to-[#93bbf6]">
      ...
      <button
        onClick={() => scroll('left')}
        className="hidden lg:flex items-center justify-center absolute left-3 top-[60%] transform -translate-y-1/2 p-2"
      >
        <Image src="/arrow.svg" alt="Left" width={24} height={24} className="rotate-180" />
      </button>
      <button
        onClick={() => scroll('right')}
        className="hidden lg:flex items-center justify-center absolute right-3 top-[60%] transform -translate-y-1/2 p-2"
      >
